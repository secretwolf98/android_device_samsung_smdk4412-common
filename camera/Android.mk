...
ifneq ($(filter i9300 i9305 n7100 t0lte t0lteatt t0ltetmo t0ltekor t0ltejpn i605 l900 r950 n8000 n8013,$(TARGET_DEVICE)),)
...
ifneq ($(filter n8000 n8013,$(TARGET_DEVICE)),)
